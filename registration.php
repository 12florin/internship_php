...
<form method="get" class ="navbar-form navbar-right" action="" id="language_form">
    <div class="form-group">
        <select name="lang"  class ="form-control" onchange="changeLanguage()" >
            <option value="en" <?php if(isset($_GET['lang']) && $_SESSION['lang']=='en'){ echo "selected";} ?> >English</option>
            <option value="es" <?php if(isset($_GET['lang']) && $_SESSION['lang']=='es'){ echo "selected";} ?> >Spanish</option>
        </select>
    </div>
        ...
        <h1><?php echo _REGISTER; ?></h1>
            <form role="form" action="registration.php" method="post" id="login-form" autocomplete="off">
                ...
                <p><?php echo isset($error['username']) ? $error['username'] : '' ?></p>
                    ...
                    <input type="password" name="password" id="password" class="form-control" placeholder="placeholder="<?php echo _PASSWORD; ?>>
